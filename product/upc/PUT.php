...
class Put_Product extends Product {
  protected $put_query_string = "UPDATE products SET sku=:sku, upc=:upc, name=:name, manufacturer=:manufacturer, category=:category, wholesale=:wholesale, taxable=:taxable, qoh=:qoh, retail=:retail, discount=:discount, discount_type=:discount_type WHERE upc=:upc";
  protected $get_query_string = "SELECT * FROM products WHERE upc=:id";
  public $body;

  public function execute() {
    $get_query_parameters = array ('id'=>$this->upc);
